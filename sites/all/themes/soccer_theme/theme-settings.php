 ...
 */
function soccer_theme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['soccer_theme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('soccer_theme sample setting'),
  '#default_value' => theme_get_setting('soccer_theme_example'),
